...
@Entity
@Table(name = "sample_child")
@Data
@NoArgsConstructor
@EqualsAndHashCode(callSuper=true)
@ToString(callSuper=true)
public class SampleChild extends BaseEntity  {
    ...
    @NotNull(groups={Insert.class, Update.class, Delete.class})
    @Min(value=3L, groups={Common.class, Search.class, Insert.class, Update.class, Delete.class})
    @Max(value=8L, groups={Common.class, Search.class, Insert.class, Update.class, Delete.class})
	@Column(name = "long_col")
    private Long longCol;

    @Digits(integer=3, fraction=2, groups={Common.class, Search.class, Insert.class, Update.class, Delete.class})
	@Column(name = "decimal_col")
    private BigDecimal decimalCol;

    @Size(min=1, max=5, groups={Common.class, Search.class, Insert.class, Update.class, Delete.class})
	@Column(name = "text_col")
    private String textCol;

    @Size(min=1, max=255, groups={Common.class, Search.class, Insert.class, Update.class, Delete.class})
	@Column(name = "password_col")
    private String passwordCol;

    @Size(min=1, max=10, groups={Common.class, Search.class, Insert.class, Update.class, Delete.class})
